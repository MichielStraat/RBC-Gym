...
step_render_time = timeit("step_render()", number=iterations, globals=globals())
print(
    f"Average time to step with rendering: {step_render_time / iterations:.2f} seconds"
)
